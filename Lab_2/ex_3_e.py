...
#podsumowanie: średni czas działania algorytmu - zad. 3.E
print("Average time length of the algorithm based on {a} invokes: {b}".format(a=number_of_invokes, b=total_time/number_of_invokes))
...
#podsumowanie: liczba pokoleń do znalezienia najlepszego wyniku - zad. 3.E
